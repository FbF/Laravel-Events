...
return array(
	...
	/**
	 * Number of fake events to create
	 */
	'number' => 20,
	...
	'you_tube' => array(
		...
		/**
		 * One in every X events is a YouTube Video (use 0 for no YouTube Videos, or set you_tube.show to false)
		 */
		'freq' => 5,
	...
	'images' => array(
		...
		'main_image' => array(
			...
			/**
			 * One in every X events that is not a YouTube Video, has a main image (use 0 for no main images, or set
	...
	'dates' => array(
		...
		/**
		 * One in every X events spans more than 1 day (use 0 for no multi-day events)
		 */
		'multi_day_freq' => 5,
	),
	...
	'map' => array(
		...
		/**
		 * One in every X events has a map (use 0 for no maps)
		 */
		'freq' => 2,
